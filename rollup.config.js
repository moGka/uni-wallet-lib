...
export default [
  // 主要构建配置 - 生成 JavaScript 包
  {
    ...
    external: ['react', 'react-dom', 'wagmi', '@rainbow-me/rainbowkit', 'viem', '@tanstack/react-query']
  },
  // 类型定义构建配置 - 生成 TypeScript 声明文件
  {
    ...
    // 外部依赖 - 包括 CSS 文件和其他依赖
    external: [/\.css$/, 'react', 'react-dom', 'wagmi', '@rainbow-me/rainbowkit', 'viem', '@tanstack/react-query']
  }
]